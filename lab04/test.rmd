...
# combo box
renderUI({
  selectInput("category", "Category:", tv_data_c)
})
```
...
```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$views), color = "primary") })
```

### Clicks

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$clicks), color = "primary") })
```

### Comments

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$comments), color = "primary") })
```

### Follows

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$follows), color = "primary") })
```

### Collects

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$collects), color = "primary") })
```

### Forwards

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$forwards), color = "primary") })
```

### Hates

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$hates), color = "primary") })
```

### Likes

```{r results = "asis"}
renderValueBox({ valueBox(format(category_data()$likes), color = "primary") })
```
