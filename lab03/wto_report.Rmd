...
Most continents live off travel, it seems. Or maybe it's the easiest
to calculate (most services are done locally, right?)
...
Export from US to Ireland is interesting here... but can be explained: top companies
in Ireland are actually controlled by their US parents, which is related
to more favorable taxing in Ireland (see [Double Irish arrangement](https://en.wikipedia.org/wiki/Double_Irish_arrangement)).

On this plot, Ireland is compared to another EU country (Germany)

```{r}
# TODO: Explain this Ireland import sharp rise in 2019.
dataset %>% filter(
  (ProductCode == "S") &
