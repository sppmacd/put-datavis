...
This report shows exploratory data analysis of a 2023 WTO report of import and export of countries/groups of countries in various sectors of their economy. ...TODO
...
Surprisingly, the 1980 recession has a bump. (TODO: why?)
...
double_irish %>% ggplot(aes(x=Year, y=Value, color=Reporter, linetype=ImportExport)) + GG_THEME +
  geom_line() +
  geom_point() +
  labs(title="Ireland Import/Export of Services from/to USA over time", linetype="Import/Export")
```
